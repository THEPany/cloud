...
class SubscriptionController extends Controller
{
    public function index()
    {
        return Inertia::render('Subscription/Index', [
            ...
            'isTrial' => optional(auth()->user()->subscription('main'))->onTrial() ? auth()->user()->subscription('main')->trial_ends_at->format('d/m/Y') : '',
            'endSubscription' => optional(auth()->user()->subscription('main'))->ends_at ? auth()->user()->subscription('main')->ends_at->isToday() : '',
