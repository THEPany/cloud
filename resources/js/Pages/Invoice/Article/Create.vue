        ...
        <div class="bg-white rounded shadow overflow-hidden max-w-lg">
            <form @submit.prevent="submit">
                ...
                <div class="px-8 py-4 bg-grey-lightest border-t border-grey-lighter flex justify-end items-center">
                    <loading-button :loading="sending" class="btn-green" type="submit">Crear articulo</loading-button>
                </div>
            </form>
        </div>
    </layout>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.sending = true
                this.$inertia.post(this.route('invoice.articles.store', this.organization.slug), this.form)
